...
<head>
	...
	<style>
    body {
		background: url(<?= $assets ?>images/bg-3.jpg) no-repeat center center fixed !important; 
    }
    </style>
...
<body class="login-page">
    ...
    <div class="page-back1" style="padding-top: 200px;">
        ...
        <div id="login">
            <div class=" container">
                ...
                <div class="login-form-div">
                    ...
                    <div class="login-content" style="border-radius: 25px; background: #FFFFFF;">
                        ...
                        ?>
                        <?php echo admin_form_open("auth/login", 'class="login" data-toggle="validator"'); ?><br>	
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="textbox-wrap form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?= DEMO ? 'owner@cloudnet.com.kh' : ''; ?>" required="required" class="form-control" name="identity"
                            ...
                            <div class="textbox-wrap form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" value="<?= DEMO ? 'CloudNET#168' : ''; ?>" required="required" class="form-control " name="password"
                                    placeholder="<?= lang('pw') ?>"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-action col-sm-12">
                            ...
                            <a href="#forgot_password" class="btn btn-warning pull-right">&nbsp; <i class="fa fa-key"></i>
							<?php echo lang('forgot_password'); ?></a>
							<?php if ($allow_reg) { ?>
							<a href="register" class="btn btn-success col-xs-4 col-xs-offset-1">
							<?php echo lang('register'); ?></a>
							<?php } ?>
							<div class="clearfix"></div><br>
							<button type="submit" class="btn btn-success col-xs-<?= $allow_reg ? 7 : 12; ?>"><?= lang('login') ?> &nbsp; <i class="fa fa-sign-in"></i></button>
