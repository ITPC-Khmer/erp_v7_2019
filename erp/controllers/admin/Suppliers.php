...
class Suppliers extends MY_Controller
{
    ...
    function delete($id = NULL)
    {
        ...
        if ($this->companies_model->deleteSupplier($id)) {
            $this->erp->send_json(array('error' => 0, 'msg' => lang("supplier_deleted")));
        } else {
            $this->erp->send_json(array('error' => 1, 'msg' => lang("supplier_x_deleted_have_purchases")));
        }
    }
    ...
    function getSupplier($id = NULL)
    {
        ...
        $this->erp->send_json(array(array('id' => $row->id, 'text' => $row->company)));
    }
