...
class Transfers extends MY_Controller
{
    ...
    function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $grand_total = $this->erp->formatDecimal(($total + $shipping + $product_tax), 4);
            ...
            if (isset($_FILES["userfile"])) {
                ...
                foreach ($final as $csv_pr) {
                    ...
                    if (isset($item_code) && isset($unit_cost) && isset($item_quantity)) {
                        ...
                        $product_tax += $pr_item_tax;
                        $subtotal = $this->erp->formatDecimal((($item_net_cost * $item_quantity) + $pr_item_tax), 4);
                        ...
                        $product = array(
                            ...
                            'net_unit_cost' => $item_net_cost,
                            'unit_cost' => $this->erp->formatDecimal($unit_cost, 4),
                            'quantity' => $item_quantity,
    ...
    function delete($id = NULL)
    {
        ...
        if ($this->transfers_model->deleteTransfer($id)) {
            if($this->input->is_ajax_request()) {
                $this->erp->send_json(array('error' => 0, 'msg' => lang("transfer_deleted")));
            }
