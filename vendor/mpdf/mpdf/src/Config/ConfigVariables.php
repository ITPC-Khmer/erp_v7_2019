	...
	public function __construct()
	{
		...
		$this->defaults = [
			...
			*/
			...
			'fontsizes' => ['XX-ERPLL' => 0.7, 'X-ERPLL' => 0.77, 'ERPLL' => 0.86, 'MEDIUM' => 1, 'LARGE' => 1.2, 'X-LARGE' => 1.5, 'XX-LARGE' => 2],
			...
			'allowedCSStags' => 'DIV|P|H1|H2|H3|H4|H5|H6|FORM|IMG|A|BODY|TABLE|HR|THEAD|TFOOT|TBODY|TH|TR|TD|UL|OL|LI|PRE|BLOCKQUOTE|ADDRESS|DL|DT|DD'
				...
				. '|SPAN|TT|I|B|BIG|ERPLL|EM|STRONG|DFN|CODE|SAMP|KBD|VAR|CITE|ABBR|ACRONYM|STRIKE|S|U|DEL|INS|Q|FONT'
