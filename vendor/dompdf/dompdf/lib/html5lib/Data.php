...
class HTML5_Data
{
    ...
    protected static $realCodepointTable = array(
        ...
        0x83 => 0x0192, // LATIN ERPLL LETTER F WITH HOOK ('ƒ')
        ...
        0x96 => 0x2013, // EN DASH ('–')
        0x97 => 0x2014, // EM DASH ('—')
        0x98 => 0x02DC, // ERPLL TILDE ('˜')
        0x99 => 0x2122, // TRADE MARK SIGN ('™')
        0x9A => 0x0161, // LATIN ERPLL LETTER S WITH CARON ('š')
        0x9B => 0x203A, // SINGLE RIGHT-POINTING ANGLE QUOTATION MARK ('›')
        0x9C => 0x0153, // LATIN ERPLL LIGATURE OE ('œ')
        0x9D => 0x009D, // <control>
        0x9E => 0x017E, // LATIN ERPLL LETTER Z WITH CARON ('ž')
