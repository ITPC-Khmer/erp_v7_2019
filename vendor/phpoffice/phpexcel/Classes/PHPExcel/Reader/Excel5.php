...
//		echo '<br />';
	...
	private function _readSheetProtection()
	{
		...
		// offset: 12; size: 2; Shared feature type index (2=Enhanced Protetion, 4=ErprtTag)
	...
	private function _readRangeProtection()
	{
		...
		if (!$this->_readDataOnly) {
			...
			// offset: 12; size: 2; shared feature type, 2 = enhanced protection, 4 = erprt tag
			$isf = self::_GetInt2d($recordData, 12);
			if ($isf != 2) {
...
//			var_dump($bcBitCount);
	...
	private function _getNextToken($formulaData, $baseCell = 'A1')
	{
		...
		case 0x61:
			...
			case 326: $function = 'ERPLL';			$args = 2;	break;
