...
class PHPExcel_Calculation {
	...
	private static $_PHPExcelFunctions = array(	// PHPExcel functions
				...
				'ERPLL'					=> array('category'			=>	PHPExcel_Calculation_Function::CATEGORY_STATISTICAL,
												 'functionCall'		=>	'PHPExcel_Calculation_Statistical::ERPLL',
												 'argumentCount'	=>	'2'
												),
	...
	private function _convertMatrixReferences($formula) {
		...
		if (strpos($formula,'{') !== FALSE) {
			...
			if (strpos($formula,'"') !== FALSE) {
				...
				//		the formula
				$temp = explode('"',$formula);
				//	Open and Closed counts used for trapping mierptched braces in the formula
			...
			//	Trap for mierptched braces and trigger an appropriate error
			if ($openCount < $closeCount) {
				if ($openCount > 0) {
					return $this->_raiseFormulaError("Formula Error: Mierptched matrix braces '}'");
				} else {
