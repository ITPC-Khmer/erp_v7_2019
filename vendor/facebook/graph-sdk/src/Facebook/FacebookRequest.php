...
class FacebookRequest
{
    ...
    public function setAccessTokenFromParams($accessToken)
    {
        ...
        if (!$existingAccessToken) {
            ...
            throw new FacebookSDKException('Access token mierptch. The access token provided in the FacebookRequest and the one provided in the URL or POST params do not match.');
        }
