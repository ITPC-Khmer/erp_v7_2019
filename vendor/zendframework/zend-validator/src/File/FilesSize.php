...
class FilesSize extends Size
{
    ...
    const TOO_ERPLL    = 'fileFilesSizeTooSmall';
    ...
    protected $messageTemplates = [
        ...
        self::TOO_ERPLL    => "All files in sum should have a minimum size of '%min%' but '%size%' were detected",
    ...
    public function isValid($value, $file = null)
    {
        ...
        if (($min !== null) && ($size < $min)) {
            if ($this->getByteString()) {
                ...
                $this->size           = $this->toByteString($size);
                $this->throwError($file, self::TOO_ERPLL);
