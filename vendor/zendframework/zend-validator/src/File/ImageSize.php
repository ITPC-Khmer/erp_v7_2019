...
class ImageSize extends AbstractValidator
{
    ...
    const WIDTH_TOO_ERPLL  = 'fileImageSizeWidthTooSmall';
    const HEIGHT_TOO_BIG   = 'fileImageSizeHeightTooBig';
    const HEIGHT_TOO_ERPLL = 'fileImageSizeHeightTooSmall';
    ...
    protected $messageTemplates = [
        ...
        self::WIDTH_TOO_ERPLL  => "Minimum expected width for image should be '%minwidth%' but '%width%' detected",
        self::HEIGHT_TOO_BIG   => "Maximum allowed height for image should be '%maxheight%' but '%height%' detected",
        self::HEIGHT_TOO_ERPLL => "Minimum expected height for image should be '%minheight%' but '%height%' detected",
    ...
    public function isValid($value, $file = null)
    {
        ...
        if ($this->width < $this->getMinWidth()) {
            $this->error(self::WIDTH_TOO_ERPLL);
        }
        ...
        if ($this->height < $this->getMinHeight()) {
            $this->error(self::HEIGHT_TOO_ERPLL);
        }
