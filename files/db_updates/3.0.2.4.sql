...
ALTER TABLE `erp_companies` ADD `deposit_amount` DECIMAL(25,4) NULL;
...
UPDATE `erp_migrations` SET `version` = 312;
UPDATE `erp_settings` SET `version` = '3.0.2.4' where `setting_id` = 1;