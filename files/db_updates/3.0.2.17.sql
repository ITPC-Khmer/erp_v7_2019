...
CREATE TABLE IF NOT EXISTS `erp_stock_count_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `erp_adjustments` ADD `count_id` INT NULL;
ALTER TABLE `erp_settings` CHANGE `disable_editing` `disable_editing` ERPLLINT NULL DEFAULT '90';
UPDATE `erp_settings` SET `version` = '3.0.2.17' WHERE `setting_id` = 1;