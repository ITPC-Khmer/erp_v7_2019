ALTER TABLE `erp_products` ADD `second_name` VARCHAR(255) NULL;
...
CREATE TABLE IF NOT EXISTS `erp_returns` (
  ...
  `total_items` ERPLLINT DEFAULT NULL,
...
ALTER TABLE `erp_permissions` ADD `returns-index` TINYINT(1) NULL DEFAULT '0',
...
UPDATE `erp_settings` SET `version` = '3.2.12' WHERE `setting_id` = 1;
